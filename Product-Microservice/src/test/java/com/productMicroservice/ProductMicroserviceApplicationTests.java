...
class ProductMicroserviceApplicationTests {
    ...
    public void test_addNewProduct() throws Exception {
        ...
        Product product = new Product("63c8c5de2461106d9019da33",
                "Samsung",
                "S20 Ultra",
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.result.productId").value("63c8c5de2461106d9019da33"));
    ...
    public void test_getProductById() throws Exception {
        ...
        Mockito.when(productDao.findById("63c8c5de2461106d9019da33")).thenReturn(Optional.ofNullable(product));
        mockMvc.perform(MockMvcRequestBuilders
                        .get(URL + "/{productId}", "63c8c5de2461106d9019da33")
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("*").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.result.productId").value("63c8c5de2461106d9019da33"))
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(2)));
        Mockito.verify(productDao, Mockito.times(1)).findById("63c8c5de2461106d9019da33");
        Mockito.verifyNoMoreInteractions(productDao);
    }
    ...
    public void test_updateProductById() throws Exception {
        ProductRequestDTO productRequestDTO = new ProductRequestDTO(
                ...
                "Mobiles & Tablets",
                "iDestiny");
        ProductResponseDTO productResponseDTO = new ProductResponseDTO("63c8c4bb2461106d9019da31",
                "Apple iPhone",
                "iPhone 14 pro max",
                BigDecimal.valueOf(130000),
                "Mobiles & Tablets",
                "iDestiny",
                "cfd42e9c");
        Product productUpdate = new Product("63c8c4bb2461106d9019da31",
                "Apple iPhone",
                "iPhone 14 pro max",
                BigDecimal.valueOf(130000),
                "Mobiles & Tablets",
        ...
        Mockito.when(productDao.findById("63c8c4bb2461106d9019da31")).thenReturn(Optional.of(productUpdate));
        Mockito.when(productDao.save(ArgumentMatchers.any(Product.class))).thenReturn(productUpdate);
        mockMvc.perform(MockMvcRequestBuilders
                        .put(URL + "/update/{productId}", "63c8c4bb2461106d9019da31")
                        .content(convertObjectAsString(productRequestDTO))
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isCreated())
                .andExpect(MockMvcResultMatchers.jsonPath("*").exists())
                .andExpect(MockMvcResultMatchers.jsonPath("$.result.productId").value("63c8c4bb2461106d9019da31"))
                .andExpect(MockMvcResultMatchers.jsonPath("$[*]", Matchers.hasSize(2)));
    }
